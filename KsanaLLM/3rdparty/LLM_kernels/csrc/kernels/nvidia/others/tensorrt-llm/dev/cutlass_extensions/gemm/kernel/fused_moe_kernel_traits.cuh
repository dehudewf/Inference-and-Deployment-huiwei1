...
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_extensions/gemm/kernel/moe_cute_util.cuh"
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_extensions/gemm/kernel/moe_problem_visitor.h"
...
EpilogueRouting<llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefault>(bool /*is_gate*/) {
  return Activation_Type::Identity;
}

template <>
constexpr Activation_Type
EpilogueRouting<llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefaultReLU>(bool /*is_gate*/) {
  return Activation_Type::Relu;
}

template <>
constexpr Activation_Type
EpilogueRouting<llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefaultSilu>(bool is_gate) {
  return is_gate ? Activation_Type::Swiglu : Activation_Type::Silu;
}

template <>
constexpr Activation_Type
EpilogueRouting<llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefaultFtGelu>(bool is_gate) {
...
struct Fused_Moe_Kernel_traits_sm80 {
  ...
  using GmemTiledCopyO =
      decltype(cute::make_tiled_copy(cute::Copy_Atom<cute::DefaultCopy, ElementOutput>{}, GmemLayoutAtomO{},
  ...
  using ActivationFn = std::conditional_t<
      ...
      std::conditional_t<
          activation_type == Activation_Type::Relu, cutlass::epilogue::thread::ReLU<float>,
  ...
  static constexpr bool can_implement(int const avaliable_smem_size) { return avaliable_smem_size > kSmemSize; }
