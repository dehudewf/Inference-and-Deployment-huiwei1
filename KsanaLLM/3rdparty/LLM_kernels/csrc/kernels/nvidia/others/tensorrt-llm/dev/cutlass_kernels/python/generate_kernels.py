...
EpiTag = {
    ...
    "llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefault",
    TrtLlm_EpilogueTag.epilogue_op_bias:
    "llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpBias",
    TrtLlm_EpilogueTag.epilogue_op_silu:
    "llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefaultSilu",
    TrtLlm_EpilogueTag.epilogue_op_gelu:
    "llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpDefaultFtGelu"
}

EpiFusion = {
    TrtLlm_EpilogueFusion.epilogue_fusion_none:
    "llm_kernels::nvidia::tensorrt_llm::dev::TmaWarpSpecializedGroupedGemmInput::EpilogueFusion::NONE",
    TrtLlm_EpilogueFusion.epilogue_fusion_finalize:
    "llm_kernels::nvidia::tensorrt_llm::dev::TmaWarpSpecializedGroupedGemmInput::EpilogueFusion::FINALIZE",
}
...
{out_tag}*, int, int, int, const int, llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::CutlassGemmConfig, char*, size_t, cudaStream_t, int*
);"""
...
if __name__ == "__main__":
    ...
    fpA_intB_inl = "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_kernels/fpA_intB_gemm/launchers/fpA_intB_launcher_sm90.inl"
    moe_gemm_inl = "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_kernels/moe_gemm/launchers/moe_gemm_tma_ws_launcher.inl"
    # moe_gemm_inl = "tensorrt_llm/kernels/internal_cutlass_kernels/src/moe_gemm/launchers/moe_gemm_tma_ws_launcher.inl"
    moe_mixed_gemm_inl = "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_kernels/moe_gemm/launchers/moe_gemm_tma_ws_mixed_input_launcher.inl"
    ...
    sm80_moe_gemm_inl = "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_kernels/moe_gemm/launchers/fused_moe_gemm_launcher_sm80.inl"
