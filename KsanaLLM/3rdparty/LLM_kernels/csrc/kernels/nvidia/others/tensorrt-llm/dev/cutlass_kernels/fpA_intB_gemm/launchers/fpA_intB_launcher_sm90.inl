...
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_extensions/gemm/collective/collective_builder_interleaved.hpp"
...
void sm90_generic_mixed_gemm_kernelLauncher(ActivationType const* A, WeightType const* B,
  ...
  if constexpr (!should_filter_tma_warp_specialized_gemm_problem_shape_v<cutlass::arch::Sm90, CTAShape, ClusterShape,
    ...
    static_assert(
        std::is_same_v<EpilogueTag, llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::EpilogueOpBias>, "");
    ...
    using CollectiveEpilogue = typename cutlass::epilogue::collective::CollectiveBuilder<
        ArchTag, OperatorClass, TileShape, ClusterShape, EpilogueTileType, ElementAccumulator, ElementAccumulator,
    ...
    using CollectiveMainloop = typename cutlass::gemm::collective::CollectiveBuilderInterleaved<
        ArchTag, OperatorClass, ElementBCollectiveInfo, LayoutB_Transpose, AlignmentB, CutlassActivationType,
    ...
    if (occupancy != nullptr) {
      *occupancy =
          llm_kernels::nvidia::tensorrt_llm::dev::cutlass_extensions::compute_occupancy_for_kernel<GemmKernel, true>();
      return;
    }
