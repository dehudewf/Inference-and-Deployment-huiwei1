...
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_extensions/gemm/kernel/fused_moe_kernel_routine.cuh"
...
struct Fused_Moe_Kernel_sm80 {
  ...
  using ProblemVisitor = cutlass::gemm::kernel::MoeProblemVisitor<
      cutlass::gemm::kernel::detail::GemmGroupedProblemSizeHelper<cutlass::gemm::GemmShape<kMaxTileM, kTileN, kTileK>,
                                                                  false>,
  ...
  static constexpr int kSmemSize =
      use_m16 ? (BaseKernelTraits::kSmemSize > BaseKernelTraits_m16::kSmemSize ? BaseKernelTraits::kSmemSize
...
#define ROUTINE_PATH(kTileM_size)                                                                                   \
  {                                                                                                                 \
    ...
    using RoutineTraits = Fused_Moe_Kernel_routine_sm80<ElementInput, ElementWeight, ElementOutput, kTileM, kTileN, \
                                                        kTileK, kStages, activation_type>;                          \
    ...
    while (problem_visitor.next_tile()) {
      ...
      if (residue_m > kMaxTileM / 2) {
        using RoutineTraits = Fused_Moe_Kernel_routine_sm80<ElementInput, ElementWeight, ElementOutput, kMaxTileM,
