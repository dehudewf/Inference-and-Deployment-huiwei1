...
class QuantMode {
 ...
 public:
  ...
  static constexpr QuantMode w4a8Mxfp4Fp8() noexcept { return QuantMode(BaseType(1u) << 14); }

  static constexpr QuantMode w4a8Mxfp4Mxfp8() noexcept { return QuantMode(BaseType(1u) << 15); }

  static constexpr QuantMode w4a16Mxfp4() noexcept { return QuantMode(BaseType(1u) << 16); }
  ...
  constexpr bool hasW4a8Mxfp4Fp8() const noexcept { return isSet(w4a8Mxfp4Fp8()); }

  constexpr bool hasW4a8Mxfp4Mxfp8() const noexcept { return isSet(w4a8Mxfp4Mxfp8()); }

  constexpr bool hasW4a16Mxfp4() const noexcept { return isSet(w4a16Mxfp4()); }

  constexpr bool hasKvCacheQuant() const noexcept { return hasInt8KvCache() || hasFp8KvCache() || hasFp4KvCache(); }

  static constexpr QuantMode fromDescription(bool quantizeWeights, bool quantizeActivations, bool perToken,
                                             bool perChannel, bool perGroup, bool useInt4Weights, bool useInt8KvCache,
                                             bool useFp8KvCache, bool useFp8Qdq, bool useFp8RowWise, bool useW4a8QServe,
                                             bool useFp4Quant, bool useFp8BlockScales, bool useW4a8Mxfp4Fp8,
  ...
  static QuantMode const fromQuantAlgo(std::optional<std::string> quantAlgo = std::nullopt,
    ...
    if (quantAlgo == "W8A16") {
      ...
      quantMode = fromDescription(false, false, false, false, false, false, false, false, true, false, false, false,
                                  false, false, false, false);
      ...
      quantMode = fromDescription(false, false, false, false, false, false, false, false, false, false, false, false,
