...
#include "csrc/kernels/nvidia/others/tensorrt-llm/dev/cutlass_kernels/include/common.h"
...
class CutlassFpAIntBGemmRunner : public virtual CutlassFpAIntBGemmRunnerInterface {
 public:
  ...
  void gemm(void const* A, void const* B, void const* weight_scales, void const* weight_zero_points, void const* biases,
