...
bool call_marlin_moe_kernel_ku8b128(vllm_dtype::ScalarType const& q_type, int thread_n_blocks, int thread_k_blocks,
  ...
  GPTQ_CALL_IF_MOE(vllm_dtype::kU8B128, 16, 4, 256)
  GPTQ_CALL_IF_MOE(vllm_dtype::kU8B128, 8, 8, 256)
  GPTQ_CALL_IF_MOE(vllm_dtype::kU8B128, 8, 4, 128)
  GPTQ_CALL_IF_MOE(vllm_dtype::kU8B128, 4, 8, 128)
  else {
    return false;
  }
  return true;
