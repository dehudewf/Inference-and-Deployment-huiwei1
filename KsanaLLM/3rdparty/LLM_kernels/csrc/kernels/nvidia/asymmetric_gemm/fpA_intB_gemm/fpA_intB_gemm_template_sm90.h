...
void sm90_dispatch_epilogue_schedules(ActivationType const* A, WeightType const* B, ScaleZeroType const* weight_scales,
    ...
    int k, int const group_size, llm_kernels::nvidia::cutlass_extensions::CutlassGemmConfig gemm_config, char* workspace, size_t workspace_bytes,
    cudaStream_t stream, int* occupancy = nullptr)
{

    switch (gemm_config.epilogue_schedule)
    {
    case llm_kernels::nvidia::cutlass_extensions::EpilogueScheduleType::AUTO:
    ...
    default:
        throw std::runtime_error(
            "[fpA_intB][sm90_dispatch_epilogue_schedules] epilogue schedule config is invalid for "
            "mixed "
            "type GEMM.");
        break;
    }
    ...
    cudaStream_t stream, int* occupancy = nullptr)
{
    ...
    if constexpr (tile_shapes_supported)
    {
        ...
        default:
            throw std::runtime_error(
                "[fpA_intB][sm90_dispatch_mainloop_schedules] mainloop schedule config is invalid "
                "for "
                "mixed type GEMM.");
            break;
        }
    ...
    {
        throw std::runtime_error(
            "[fpA_intB][sm90_dispatch_mainloop_schedules] Unsupported CTA and Cluster shapes for "
            "mixed type GEMM.");
    }
}
    ...
    cudaStream_t stream, int* occupancy = nullptr)
{
    ...
    {
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x1x1:
        ...
        break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_2x1x1:
        sm90_dispatch_mainloop_schedules<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp,
            EpilogueTag, CTAShape, Shape<_2, _1, _1>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n,
            k, group_size, gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_1x2x1:
        sm90_dispatch_mainloop_schedules<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp,
            EpilogueTag, CTAShape, Shape<_1, _2, _1>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n,
            k, group_size, gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::ClusterShape::ClusterShape_2x2x1:
        sm90_dispatch_mainloop_schedules<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp,
    ...
    default:
        throw std::runtime_error(
            "[fpA_intB][dispatch_CGA_config] Config is invalid for mixed type GEMM.");
        break;
    }
}
...
void sm90_dispatch_gemm_to_cutlass(ActivationType const* A, WeightType const* B, ScaleZeroType const* weight_scales,
    ScaleZeroType const* weight_zero_points, BiasType const* biases, float const alpha, OutputType* C, int m, int n,
    int k, int const group_size, char* workspace, size_t workspace_bytes, llm_kernels::nvidia::cutlass_extensions::CutlassGemmConfig gemm_config,
    cudaStream_t stream, int* occupancy = nullptr)
{
    ...
    {
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x16x128B:
        ...
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x32x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_64, _32, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x64x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_64, _64, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x128x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_64, _128, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape64x256x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_64, _256, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x16x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_128, _16, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x32x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_128, _32, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x64x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_128, _64, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x128x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_128, _128, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::CtaShape128x256x128B:
        sm90_dispatch_gemm_config<ActivationType, WeightType, ScaleZeroType, BiasType, OutputType, QuantOp, EpilogueTag,
            Shape<_128, _256, _Ktile>>(A, B, weight_scales, weight_zero_points, biases, alpha, C, m, n, k, group_size,
            gemm_config, workspace, workspace_bytes, stream, occupancy);
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::Undefined:
        throw std::runtime_error(
            "[fpA_intB][sm90_dispatch_gemm_to_cutlass] gemm config undefined.");
        break;
    case llm_kernels::nvidia::cutlass_extensions::CutlassTileConfigSM90::ChooseWithHeuristic:
        throw std::runtime_error(
            "[fpA_intB][sm90_dispatch_gemm_to_cutlass] gemm config should have already been set by "
            "heuristic.");
        break;
    default:
        throw std::runtime_error(
            "[fpA_intB][sm90_dispatch_gemm_to_cutlass] Config is invalid for mixed type GEMM.");
        break;
    }
}
