...
# Ref:
# https://github.com/vllm-project/vllm/blob/v0.9.1/vllm/transformers_utils/tokenizers/mistral.py
import os
...
def make_mistral_chat_completion_request(
    ...
    #
    # [1]: https://github.com/mistralai/mistral-common/blob/
    # f4a06998b75ed78bbf5aaf569590b772ea26c9f6/src/mistral_common/protocol/instruct/messages.py#L80
