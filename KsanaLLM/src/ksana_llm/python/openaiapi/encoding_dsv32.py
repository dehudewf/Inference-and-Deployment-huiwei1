...
def render_message(
    ...
    if role == "system":
        ...
        if thinking_mode == "thinking" and index > last_user_idx:
            ...
            ), (f"ThinkingMode: {thinking_mode}, "
                f"invalid message without reasoning_content/tool_calls `{msg}` after last user message")
            thinking_part = (
...
# NOTE: This function is designed to parse only correctly formatted string
# and will not attempt to correct malformed output that may be generated by the model.
