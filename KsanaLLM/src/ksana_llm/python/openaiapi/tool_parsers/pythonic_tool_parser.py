...
# Ref:
# https://github.com/vllm-project/vllm/blob/v0.9.1/vllm/entrypoints/openai/tool_parsers/pythonic_tool_parser.py
import ast
import json
...
from openaiapi.tool_parsers.abstract_tool_parser import (ToolParser, ToolParserManager)
...
class PythonicToolParser(ToolParser):
    ...
    def extract_tool_calls(
        ...
        except (SyntaxError, ValueError, AttributeError, TypeError, _UnexpectedAstError):
