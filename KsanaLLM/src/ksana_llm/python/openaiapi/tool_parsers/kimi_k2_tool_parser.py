...
# Ref: https://github.com/vllm-project/vllm/blob/v0.11.1rc0/vllm/entrypoints/openai/tool_parsers/kimi_k2_tool_parser.py
    ...
    def extract_tool_calls_streaming(
        ...
        try:
            ...
            if (cur_tool_start_count == cur_tool_end_count
                ...
                # NOTE(winminkong): Check if the streamed args are complete json, will be removed later.
                ...
                if self.prev_tool_call_arr is None or len(
                    ...
                    if not self.streamed_args_for_tool[self.current_tool_id]:
                        ...
                        if not self.current_tool_name_sent:
                            ...
                            logger.warning("Last delta tool_id delay out: %s", tool_id)
