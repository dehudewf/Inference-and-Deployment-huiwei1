...
class PagedSparseMlaIndexerLayer : public BaseLayer {
 public:
 ...
 private:
  ...
  int layer_num_;                // number of layers on this node
  int block_size_per_layer_;     // block size per layer = block_size / layer_num
